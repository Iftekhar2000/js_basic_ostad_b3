...
// All of the above examples will output "This is a truthy value" because they are considered truthy values 
in JavaScript.
...
//     It's important to note that the concept of truthy and falsy values can be used in a variety of 
contexts in JavaScript. For example, when checking if a value exists, you can use the shorthand if (value) 
    to check if the value is truthy, or if (!value) to check if the value is falsy.
